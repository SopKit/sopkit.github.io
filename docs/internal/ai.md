the title of page like https://sopkit.space/image-resizer is geting using generateToolMetadata func. that is not good its showing title = "Image Resizer - Free Image Tool | SopKit | SopKit" which is very high competion 
