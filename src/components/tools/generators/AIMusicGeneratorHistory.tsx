...
interface AIMusicGeneratorHistoryProps {
  history: MusicTrack[];
  clearHistory: () => void;
  loadFromHistory: (item: MusicTrack) => void;
}

export default function AIMusicGeneratorHistory({ history, clearHistory, loadFromHistory }: AIMusicGeneratorHistoryProps) {
  return (
    <Card>
      <CardHeader>
