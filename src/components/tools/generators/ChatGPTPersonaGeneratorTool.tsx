...
const ChatGPTPersonaGeneratorTool = () => {
	...
	const presetPersonas: PresetPersona[] = [
		{
	...
	const generatePersonaWithAI = async (category: string | undefined, tone: string | undefined, customInput: string) => {
		try {
...
Format as a clear persona prompt that someone can copy-paste into ChatGPT. Make it creative and entertaining!`;
	...
	const generateFallbackPersona = (category: string, tone: string) => {
									...
									{persona ? (
										<>
											...
											<SocialShareButtons
												...
												toolUrl="https://sopkit.space/chatgpt-persona-generator"
											/>
										</>
									) : (
