...
const CHAT_STYLES: Record<string, ChatStyle> = {
	whatsapp: {
		name: "WhatsApp",
		bg: "#e5ddd5",
		headerBg: "#075e54",
...
function createSvgFromElement(el: HTMLElement, w: number, h: number): SVGSVGElement {
...
export default function FakeChatGeneratorTool() {
	const [chatStyle, setChatStyle] = useState<string>("whatsapp");
