						...
						<div className="space-y-6">
							<div className="space-y-2">
								...
								<input
									...
									onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMonthlyInstallment(e.target.value)}
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
								<div className="space-y-2">
									...
									<input
										...
										onChange={(e: React.ChangeEvent<HTMLInputElement>) => setRateOfInterest(e.target.value)}
										className="h-14 w-full rounded-2xl bg-muted/20 border border-border/40 px-6 font-bold focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all text-lg"
									/>
								</div>
								...
								<div className="space-y-2">
									...
									<input
										type="number"
										value={tenureMonths}
										onChange={(e: React.ChangeEvent<HTMLInputElement>) => setTenureMonths(e.target.value)}
										className="h-14 w-full rounded-2xl bg-muted/20 border border-border/40 px-6 font-bold focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all text-lg"
									/>
								</div>
							</div>
