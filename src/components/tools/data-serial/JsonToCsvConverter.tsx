...
export default function JsonToCsvConverter() {
  ...
  return (
    <Card className="border-border/60 shadow-sm">
      <CardHeader>
        <CardTitle className="text-lg">JSON to CSV Converter</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <Textarea className="min-h-[220px] font-mono text-sm bg-muted/30" readOnly value={output} placeholder="CSV output" />
      </CardContent>
    </Card>
  );
}
