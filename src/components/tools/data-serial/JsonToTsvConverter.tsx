...
export default function JsonToTsvConverter() {
  ...
  return (
    <Card className="border-border/60 shadow-sm">
      <CardHeader>
        <CardTitle className="text-lg">JSON to TSV Converter</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <Button type="button" onClick={run}>Convert to TSV</Button>
        <Textarea className="min-h-[220px] font-mono text-sm bg-muted/30" readOnly value={output} placeholder="TSV output" />
      </CardContent>
    </Card>
  );
}
