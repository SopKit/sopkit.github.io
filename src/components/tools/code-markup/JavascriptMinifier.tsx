...
export default function JavascriptMinifier() {
  ...
  return (
    <Card className="border-border/60 shadow-sm">
      <CardHeader>
        <CardTitle className="text-lg">JavaScript Minifier</CardTitle>
      </CardHeader>
      <CardContent className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2"><Button type="button" variant="secondary" onClick={run}>Minify JS</Button></div>
