...
export const INTENT_TOOL_REGISTRY: Record<string, { component: React.ComponentType<any>; props: any }> = {
    ...
    "ico-to-png-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "png" } },
    ...
    "jpg-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "jpeg" } },
    "jpg-to-bmp-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "bmp" } },
    "jpg-to-gif-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "gif" } },
    "jpg-to-ico-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "png" } },
    "jpg-to-pdf-exam-forms": { component: JpgToPdfExam, props: {} },
    "jpg-to-png-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "png" } },
    "jpg-to-webp-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "webp" } },
    ...
    "png-to-bmp-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "bmp" } },
    "png-to-gif-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "gif" } },
    "png-to-ico-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "png" } },
    "png-to-jpg-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "jpeg" } },
    "png-to-webp-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "webp" } },
    ...
    "webp-to-jpg-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "jpeg" } },
    "webp-to-png-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "png" } },
    "svg-to-jpg-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "jpeg" } },
    "svg-to-png-converter": { component: ImageConverterTool, props: { defaultOutputFormat: "png" } },
