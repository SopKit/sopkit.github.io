...
export default function TextToAsciiConverter() {
  ...
  const convertNow = useCallback(() => {
    ...
    try {
      const kind: string = "text-to-ascii";
      let out = "";
      switch (kind) {
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <label className="text-sm font-semibold tracking-tight uppercase opacity-60">Output (ASCII codes)</label>
