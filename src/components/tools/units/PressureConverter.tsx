...
export default function PressureConverter() {
  ...
  return (
    <Card className="border-border/60 shadow-sm">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-lg"><ArrowRightLeft className="h-5 w-5 text-primary" />Pressure Converter</CardTitle>
      </CardHeader>
