...
export const metadata = {
	...
	description: "Edit, convert, and compress images with our free Compress Image to 20KB online. Crop, resize, and optimize photos in your browser with no signup. Free & secure.",
