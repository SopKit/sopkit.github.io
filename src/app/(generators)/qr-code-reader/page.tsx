...
export const metadata = generateToolMetadata({
	name: "QR Code Reader",
	description: "Private QR Code Reader: privately process content entirely in your browser. 100% client-side sandbox — no server uploads, no AI training, no data collection. Unlike tools that sell your data, SopKit processes everything locally. Free, instant, and secure.",
