...
export const metadata = {
	...
	keywords: "url parser, free online tool, no signup, url-parser, free url-parser, Url Parser online, online utility, web calculator, free converter, browser tool, SopKit",
	alternates: {
