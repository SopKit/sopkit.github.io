...
export const metadata = {
	...
	keywords: "binary to ascii converter, free online tool, no signup, binary-to-ascii-converter, free binary-to-ascii-converter, Binary To Ascii Converter online, developer tool, web dev utility, code formatter, online developer, SopKit",
	alternates: {
