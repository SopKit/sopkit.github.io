...
export const metadata = {
	...
	keywords: "hex to binary converter, free online tool, no signup, hex-to-binary-converter, free hex-to-binary-converter, Hex To Binary Converter online, developer tool, web dev utility, code formatter, online developer, SopKit",
	alternates: {
