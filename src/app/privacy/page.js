...
export const metadata = {
  title: "Privacy Policy - SopKit",
  description:
    "Read SopKit's Privacy Policy. Learn how we collect, use, and protect your data while using our free web development tools.",
  alternates: {
...
export default function page() {
  return (
    <div>
      ...
      <h3 id="2useofyourinformation">2. Use of Your Information</h3>
      ...
      <ul>
        ...
        <li>
          ...
          rewards, and events offered by SopKit and provide news and information
          we think will be of interest to you
        </li>
      </ul>
      <h3 id="3disclosureofyourinformation">
      ...
      <h3 id="4trackingtechnologies">4. Tracking Technologies</h3>
      <p>
      ...
      <h3 id="5securityofyourinformation">5. Security of Your Information</h3>
      <p>
      ...
      <h3 id="6policyforchildren">6. Policy for Children</h3>
      <p>
      ...
      <h3 id="7changestothisprivacypolicy">
      ...
      <p>
        ...
        new Privacy Policy on the Site.
      </p>
      <h3 id="8contactus">8. Contact Us</h3>
      <p>
        If you have questions or comments about this Privacy Policy, please
        contact us at:
      </p>
      <pre>
        <code>Email: sh20raj@gmail.com{"\n"}</code>
      </pre>
    </div>
  );
}
