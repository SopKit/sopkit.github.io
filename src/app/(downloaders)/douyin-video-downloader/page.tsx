...
export const metadata = {
	...
	description: "Download, convert, and edit video files instantly with our free Douyin Video Downloader online. Fast, secure, and private processing with no signup. 100% free.",
