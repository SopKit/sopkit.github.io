...
export const metadata = {
	title: "Free Protein Intake Calculator Online - No Signup | SopKit",
	description: "Compute rates, taxes, averages, and conversions with our free Protein Intake Calculator online. Quick, accurate browser calculator with no registration.",
