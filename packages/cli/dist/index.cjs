...
var xml = __toESM(require("@sopkit/xml"), 1);
var jwt = __toESM(require("@sopkit/jwt"), 1);
var hash = __toESM(require("@sopkit/hash"), 1);
async function main() {
...
`);
      ...
      const keyPrompt = await (0, import_prompts.default)({
        type: "password",
        name: "key",
